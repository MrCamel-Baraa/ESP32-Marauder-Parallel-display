...
void setup()
{
  ...
  // Init PWM brightness AFTER display init (so ledcAttach overrides TFT_eSPI's pinMode)
    ...
    backlightOff();
      ...
      display_obj.tft.drawCentreString("Baraa Elgamal", TFT_WIDTH/2, TFT_HEIGHT * 0.5, 1);
      ...
      display_obj.tft.drawCentreString("Baraa Elgamal", TFT_HEIGHT/2, TFT_WIDTH * 0.5, 1);
